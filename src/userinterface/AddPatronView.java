...
//==============================================================
public class AddPatronView extends View
{
    ...
    //----------------------------------------------------------
    public AddPatronView(IModel patron)
    {
        super(patron, "AddPatronView");
    ...
    private VBox createFormContent()
    {
        ...
        Text prompt = new Text("ADD A PATRON");
        prompt.setWrappingWidth(400);
        prompt.setTextAlignment(TextAlignment.CENTER);
        prompt.setFill(Color.BLACK);
        grid.add(prompt, 0, 0, 2, 1);

        Text bookNameLabel = new Text(" Patron Name : ");
